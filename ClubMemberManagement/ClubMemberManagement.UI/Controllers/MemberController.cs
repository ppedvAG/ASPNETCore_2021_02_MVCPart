...
namespace ClubMemberManagement.UI.Controllers
{
    ...
    public class MemberController : Controller
    {
        ...
        public MemberController(ClubMemberManagementDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Vorname,Nachname,Geburtstag,Vereinseintritt,Straße,Hausnummer,PLZ,Ort,Land,Email,Phone,Mobile")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Vorname,Nachname,Geburtstag,Vereinseintritt,Straße,Hausnummer,PLZ,Ort,Land,Email,Phone,Mobile")] Member member)
        {
            if (id != member.ID)
            {
                return NotFound();
